...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'user.form.registration' => 'getUser_Form_RegistrationService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('qvle9gVc47', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LMp7w-8Kar', 0, 'w7gBoflXLdYBXNs1GwSRjC', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'SeeToLearn', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/TextBundle/Entity'), 2 => ($this->targetDirs[3].'/src/MotBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'UserBundle\\Entity');
        $c->addDriver($b, 'TextBundle\\Entity');
        $c->addDriver($b, 'MotBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('UserBundle' => 'UserBundle\\Entity', 'TextBundle' => 'TextBundle\\Entity', 'MotBundle' => 'MotBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e3e6ac965a7daf21e9d3969c7991e6ab15b6d10221cd1fa2e53da6413879f0d3');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('noreply@example.com' => 'Demo App'), 'resetting' => array('noreply@example.com' => 'Demo App'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'UserBundle\\Form\\RegistrationType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager(${($_ = isset($this->services['fos_user.util.password_updater']) ? $this->services['fos_user.util.password_updater'] : $this->getFosUser_Util_PasswordUpdaterService()) && false ?: '_'}, ${($_ = isset($this->services['fos_user.util.canonical_fields_updater']) ? $this->services['fos_user.util.canonical_fields_updater'] : $this->getFosUser_Util_CanonicalFieldsUpdaterService()) && false ?: '_'}, $this->get('doctrine')->getManager(NULL), 'UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('w5o+9JZsnE', NULL, 'w7gBoflXLdYBXNs1GwSRjC', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $o->setOptions(array('login_path' => '/login', 'default_target_path' => '/tableau', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/IndexBundle/Resources/views'), 'Index');
        $instance->addPath(($this->targetDirs[3].'/src/TextBundle/Resources/views'), 'Text');
    ...
    /**
     * Gets the 'user.form.registration' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\Form\RegistrationType A UserBundle\Form\RegistrationType instance
     */
    protected function getUser_Form_RegistrationService()
    {
        return $this->services['user.form.registration'] = new \UserBundle\Form\RegistrationType();
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('coAwUByVVp', 0, 'w7gBoflXLdYBXNs1GwSRjC', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'IndexBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/IndexBundle'),
                    'namespace' => 'IndexBundle',
                ),
                'TextBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/TextBundle'),
                    'namespace' => 'TextBundle',
                ),
                'MotBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/MotBundle'),
                    'namespace' => 'MotBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'IndexBundle' => 'IndexBundle\\IndexBundle',
                'TextBundle' => 'TextBundle\\TextBundle',
                'MotBundle' => 'MotBundle\\MotBundle',
